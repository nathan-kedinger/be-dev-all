 ...
 */
final class Version20230326172256 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mission_languages (mission_id INT NOT NULL, languages_id INT NOT NULL, INDEX IDX_1264A450BE6CAE90 (mission_id), INDEX IDX_1264A4505D237A9A (languages_id), PRIMARY KEY(mission_id, languages_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
